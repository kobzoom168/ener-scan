...
- **Top performers:** `src/stores/scanQualityInsights.db.js` — `listTopPerformingScanResults` (default `minScoreAfter: 45`), optional `qualityTier`, `requireDeltaPositive`, `improveApplied`.