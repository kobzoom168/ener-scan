...
test("renderAmuletReportV2Html: renders sacred amulet shell", () => {
  ...
  assert.ok(html.includes('class="mv2a-radar-peak-secondary"'), "เข้ากับคุณตามสูตร: จุดรอง + pulse");
  assert.ok(
    html.includes("เข้ากับคุณที่สุด (จุดบนกราฟตามสูตร)"),
    "tooltip ระบุว่าเป็นจุดเข้ากับคุณตามสูตรจัดแนว ไม่ใช่แค่พลังรอง",
  );
