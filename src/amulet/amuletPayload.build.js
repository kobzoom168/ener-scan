...
function buildAmuletHtmlReportPlaceholder() {
  const lifeAreaBlurbs = {
    protection:
      "มิติคุ้มครอง — โฟกัสความปลอดภัยและขอบเขต ใช้เป็นกรอบอ่าน ไม่ใช่คำมั่นสัญญาเชิงวิชาการ",
    metta:
      "มิติเมตตา — ความอ่อนโยนและการได้รับการเอ็นดูในสังคมรอบตัว อ่านเป็นภาพรวม",
    baramee:
      "มิติบารมี — ท่าทีผู้นำและความน่าเชื่อถือในบทบาทที่เลือก",
    luck:
      "มิติโชคลาภ — โอกาสและการเปิดทาง ไม่ใช่การันตีผลลัพธ์",
    fortune_anchor:
      "มิติหนุนดวง — ความมั่นคงภายในและการตั้งหลักเมื่อสถานการณ์เปลี่ยน",
    specialty:
      "มิติงานเฉพาะทาง — จุดเด่นเชิงช่างหรือบทบาทเฉพาะด้าน",
  };
