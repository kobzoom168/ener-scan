 ...
 * 4. **Radar secondary marker (HTML)** — Vertex on the **object** polygon at `alignment.axisKey` when that axis ≠ peak;
 *    not `ord[1]` “พลังรอง” (second-highest object score). Tooltip: เข้ากับคุณตามสูตรจัดแนว ไม่ใช่แค่แกนรองจากเด่น.
 */
