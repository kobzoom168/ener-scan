...
export function buildSacredAmuletDecisionCard(p) {
  ...
  /** Top-finder copy per keepGrade — display-only; scoring unchanged */
  const decisionCopyByGrade = {
    S: {
      reason: "เข้ากับคุณสูง พลังเด่นชัด และส่งกับคุณตรงสุด",
      baselineHint: "ชิ้นนี้คือตัวตั้งที่แรงของรอบนี้",
      scanNextHint:
        "ถ้าจะสแกนต่อ ให้ใช้ชิ้นนี้เป็นตัวตั้ง แล้วเทียบอีก 2–3 ชิ้นในสายเดียวกัน ดูว่ามีองค์ไหนขึ้นได้เหนือกว่านี้ไหม",
    },
    A: {
      reason: "ชิ้นนี้ส่งกับคุณดี ใช้งานได้จริง และมีแกนที่ตรงกับคุณชัด",
      baselineHint: "ชิ้นนี้ใช้เป็นตัวตั้งได้ดีแล้ว",
      scanNextHint:
        'ถ้าจะสแกนต่อ ให้หาอีก 2–3 ชิ้นในสาย "เข้ากับคุณที่สุด" แล้วดูว่ามีองค์ไหนดันขึ้นได้มากกว่านี้ไหม',
    },
    B: {
      reason:
        "ชิ้นนี้มีบางด้านที่ตอบกับคุณ แต่ยังไม่ใช่ตัวที่เด่นสุดในสายนี้",
      baselineHint: "ชิ้นนี้เป็นตัวตั้งของรอบนี้ได้",
      scanNextHint:
        'ถ้าจะสแกนต่อ ให้เทียบอีก 2–3 ชิ้นในสายเดียวกัน โดยเน้นชิ้นที่เด่นทาง "เข้ากับคุณที่สุด" และอย่าเริ่มจากชิ้นที่หนักทาง "ควรค่อย ๆ ไป" มากเกินไป',
    },
    C: {
      reason: "ชิ้นนี้ยังไม่ตอบกับคุณพอ และยังมีโอกาสเจอชิ้นที่ขึ้นกว่านี้",
      baselineHint: "ชิ้นนี้ยังไม่ใช่ตัวตั้งที่ดีที่สุดของรอบนี้",
      scanNextHint:
        'ถ้าจะสแกนต่อ ให้เน้นชิ้นที่เด่นทาง "เข้ากับคุณที่สุด" มากกว่าเดิม และเลี่ยงชิ้นที่ไปหนักทาง "ควรค่อย ๆ ไป" มากเกินไป',
    },
  };

  const dc = decisionCopyByGrade[keepGrade];
  ...
  return {
    ...
    verdict,
    reason: dc.reason,
    baselineHint: dc.baselineHint,
    scanNextHint: dc.scanNextHint,
  };
}
