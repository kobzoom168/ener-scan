...
ฟิลด์ secondaryEnergyName: พลังรองสั้น ๆ ไม่ซ้ำกับ energyName (เช่น "พลังสมดุล" หรือ "พลังเมตตา") — อ้างจากด้านรองที่โดดรองจาก dimensions
...
ฟิลด์ energyName: ตั้งชื่อพลังหลักสั้น ๆ เท่านั้น (เช่น "พลังสงบสมาธิ") — ห้ามใส่วงเล็บ ห้ามต่อท้ายคำอธิบายภาพ หมวด หรือคำว่า "เฉพาะชิ้นนี้…"
