...
function buildAgeToneBlock(userAge) {
  ...
  // กติกา 11 ส.ค. (แผน scoring v4): วัยเปลี่ยนได้แค่ ความยาว/ระดับภาษา/ตัวอย่างสถานการณ์ชีวิต
  // ห้ามเปลี่ยนความมั่นใจ ความแรง หรือความอวยตามอายุ — กฎห้ามอวย (24 ก.ค.) คุมทุกวัยเท่ากัน
  if (age == null || age < 31) {
    return `
โทนภาษาผู้ใช้: วัย 20–30 — ประโยคสั้น กระชับ ภาษาพูดทั่วไปของคนรุ่นใหม่ ไม่ต้องทางการ
ตัวอย่างสถานการณ์ชีวิตที่ยกได้: เรียน สอบ สัมภาษณ์งาน งานแรก ความสัมพันธ์
ตัวอย่างโทน: “พลังชิ้นนี้เด่นทางเมตตา เหมาะช่วงต้องเจอคนใหม่ ๆ”
ห้ามใช้คำอวยหรือคำเล่นใหญ่ (ปัง/จัดไป/ฟันธง) — สาระและระดับความมั่นใจต้องเท่ากันทุกวัย
`.trim();
  }

  if (age <= 50) {
    return `
โทนภาษาผู้ใช้: วัย 31–50 (วัยทำงาน) — สุภาพ ตรงประเด็น
ตัวอย่างสถานการณ์ชีวิตที่ยกได้: งาน เจรจา ลูกค้า ครอบครัว การเงินบ้าน
ตัวอย่างโทน: “พลังของชิ้นนี้เด่นด้านบารมี เหมาะกับจังหวะที่ต้องนำทีมหรือเจรจา”
`.trim();
  }

  return `
โทนภาษาผู้ใช้: วัย 51 ปีขึ้นไป — อบอุ่น เรียบ นิ่ง ประโยคปานกลาง
ตัวอย่างสถานการณ์ชีวิตที่ยกได้: สุขภาพใจ ครอบครัว ลูกหลาน การทำบุญ
ตัวอย่างโทน: “ชิ้นนี้พลังโน้มไปทางหนุนดวง เหมาะกับการตั้งหลักและความสงบในบ้าน”
`.trim();
}
...
2. ให้คะแนนพลัง 0–10 — ใช้เกณฑ์เดียวกันทุกหมวดวัตถุ (พระ เครื่องราง หิน กำไล):
   9.0-10 = ระดับสูงสุด หายากจริง (~1-2% ของทั้งหมด) — สภาพสมบูรณ์มาก รายละเอียดงานจัดเต็ม เห็นความพิเศษหลายจุดพร้อมกันชัดเจนในภาพ (เช่น งานละเอียดจัด + เนื้อ/สีลึกสด + องค์ประกอบครบสมดุล) — เจอครบจริงให้กล้าให้ 9.0-9.5 ไม่ต้องกั๊ก · 8.5-8.9 = ของพิเศษ โดดเด่นชัดเจน · 7.0-8.4 = ดี · 5.5-6.9 = กลาง ๆ ใช้ได้ · ต่ำกว่า 5.5 = อ่อน
   กระจายคะแนนตามหลักฐานที่เห็นจริงในภาพ (สภาพ ความสมบูรณ์ ความสด/ความลึกของเนื้อและสี รายละเอียดงาน)
   ห้ามให้คะแนนสูงเพียงเพราะหมวดวัตถุขึ้นชื่อว่าพลังแรง (หิน/คริสตัล/มอลดาไวท์ไม่ได้เริ่มที่ 7.5 อัตโนมัติ — เนื้อหมอง สีจาง งานหยาบ ต้องได้คะแนนกลางหรือต่ำเหมือนหมวดอื่น)
