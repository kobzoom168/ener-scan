...
/**
 * "ผม" ที่ไม่ใช่สรรพนาม (P0-2 Codex: ห้ามใช้ verb allowlist — reject ผม ทุกแบบ)
 * ยกเว้นได้เฉพาะ compound ความหมาย "เส้นผม" ที่ชัดเจน · "ครับผม" ไม่ยกเว้น (เสียงแอดมิน — Codex รอบสี่)
 */
const NON_PRONOUN_PHOM_RE = /เส้นผม|ทรงผม|สีผม|ปอยผม|ผมหงอก|ผมร่วง/gu;

/** true = มีคำว่า "ผม" ทุกแบบ (รวม ครับผม) หลังตัด compound ความหมายเส้นผม */
