...
export async function buildCustomerFactsContext(lineUserId) {
  ...
  try {
    ...
    return [
      ...
      "• แพ็กชำระเงิน: ห้ามอาจารย์เชียร์ขาย ระบุราคา หรือเลือกแพ็กแทนลูกค้าเด็ดขาด — ถ้าลูกค้าถามเรื่องแพ็ก/อยากเปิดสิทธิ์/สิทธิ์หมด ให้บอกสั้น ๆ ว่าบอกอาจารย์มาได้เลย เดี๋ยวมีตัวเลือกเด้งให้แตะเลือก (ห้ามสอนพิมพ์คำสั่ง)",
