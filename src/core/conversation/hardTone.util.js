...
// ข้อเท็จจริงอายุแพ็ก/สิทธิ์ (ไม่ใช่สัญญาเวลาตอบ) — ต้องผูกกับคำว่า สิทธิ์/แพ็ก/โปร/อายุ
// หรือรูปแบบการ์ด "N ครั้ง · 24 ชม." / "N ครั้งใน 24 ชม." เท่านั้น
// (Codex รอบห้า: "ภายใน N นาที" ลอย ๆ = SLA ของระบบ ห้าม mask)
const VALIDITY_FACT_RE =
  /(?:(?:สิทธิ์|แพ็ก|แพค|โปร|อายุ(?:สิทธิ์|แพ็ก|การใช้งาน)?)[ก-๙\s]{0,12}?(?:ใช้ได้|มีผล|ภายใน|ตลอด|ถึง)?\s*\d+\s*(?:ชม\.|ชั่วโมง|วัน)|\d+\s*ครั้ง\s*(?:[·•/]|ใน)\s*\d+\s*(?:ชม\.|ชั่วโมง|วัน))/u;
