export const TelemetryEvents = {
  ...
  GEMINI_FRONT_PLANNER: "GEMINI_FRONT_PLANNER",
  GEMINI_FRONT_PHRASING: "GEMINI_FRONT_PHRASING",
  GEMINI_FRONT_ACTION_VALIDATION: "GEMINI_FRONT_ACTION_VALIDATION",
  GEMINI_FRONT_ORCHESTRATOR: "GEMINI_FRONT_ORCHESTRATOR",
  /** Phase-1 shadow: planner+validator observability only (no user-visible effect). */
  GEMINI_FRONT_SHADOW_REQUESTED: "GEMINI_FRONT_SHADOW_REQUESTED",
  GEMINI_FRONT_SHADOW_RESULT: "GEMINI_FRONT_SHADOW_RESULT",
  GEMINI_FRONT_SHADOW_FAILED: "GEMINI_FRONT_SHADOW_FAILED",
};
