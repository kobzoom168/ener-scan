...
${pkgRows}
    ...
    <div class="card">
      ...
      <small>
        บังคับทุกคนที่ยังไม่ลงทะเบียน (ชื่อเล่น + วันเกิด + เบอร์) รวมลูกค้าเดิม ·
        ต้องมี LIFF ผูกกับ OA ก่อนถึงทำงาน · โดนบล็อกครบ 3 ครั้งระบบถอยให้ใช้แบบเดิม · ระบบล่ม = ปล่อยผ่านเสมอ
      </small>
    </div>
