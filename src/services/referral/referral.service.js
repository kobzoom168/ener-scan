...
export const REDEEM_REPLY_TEXTS = {
  ...
  not_new: "สิทธิ์นี้สำหรับเพื่อนใหม่ที่ยังไม่เคยสแกนครับ ของคุณใช้สิทธิ์ฟรีรายวันหรือค่าครูได้ตามปกติเลยครับ",
  ...
  error: "ตอนนี้รับโค้ดไม่ได้ชั่วคราวครับ อีกสักครู่ลองพิมพ์โค้ดมาใหม่นะครับ",
