    ...
    contents: {
      ...
      body: {
        ...
        contents: [
          ...
          {
            type: "text",
            text: "วิธีใช้: ส่งข้อความด้านล่างต่อให้เพื่อน พอเพื่อนแอดไลน์แล้วพิมพ์โค้ดนี้ สิทธิ์เข้าทั้งคู่",
            size: "sm",
            color: "#555555",
            wrap: true,
            margin: "lg",
...
export const REDEEM_REPLY_TEXTS = {
  ...
  error: "รับโค้ดไม่ได้ชั่วคราว พิมพ์โค้ดใหม่อีกครั้ง",
  bad_input: "โค้ดนี้อาจารย์หาไม่เจอ ลองเช็คตัวสะกดจากเพื่อนอีกที",
};

export function buildReferrerNotifyText() {
  return "เพื่อนของคุณเข้ามารับสิทธิ์จากโค้ดชวนแล้ว อาจารย์เพิ่มสิทธิ์สแกนฟรีให้คุณ 1 ครั้ง บันทึกการชวนแล้ว";
}
