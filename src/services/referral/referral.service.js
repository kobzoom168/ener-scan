    ...
    contents: {
      ...
      body: {
        ...
        contents: [
          ...
          {
            type: "text",
            text: "วิธีใช้: ส่งข้อความด้านล่างต่อให้เพื่อน พอเพื่อนแอดไลน์แล้วพิมพ์โค้ดนี้ สิทธิ์เข้าทั้งคู่ทันที",
            size: "sm",
            color: "#555555",
            wrap: true,
            margin: "lg",
...
export const REDEEM_REPLY_TEXTS = {
  ok: "รับสิทธิ์จากเพื่อนเรียบร้อย ได้สแกนฟรีเพิ่ม 1 ครั้ง ส่งรูปพระหรือเครื่องรางที่อยากรู้พลังมาได้",
  not_found: "โค้ดนี้อาจารย์หาไม่เจอ ลองเช็คตัวสะกดจากเพื่อนอีกที",
  self: "โค้ดนี้เป็นของคุณเอง ส่งต่อให้เพื่อนที่ยังไม่เคยสแกนใช้ได้",
  not_new: "สิทธิ์นี้สำหรับเพื่อนใหม่ที่ยังไม่เคยสแกน ของคุณใช้สิทธิ์ฟรีรายวันหรือค่าครูได้ตามปกติเลย",
  already_redeemed: "บัญชีนี้เคยรับสิทธิ์ชวนเพื่อนไปแล้ว รับได้ครั้งเดียว",
  cap_reached: "โค้ดนี้ใช้สิทธิ์ชวนครบรอบเดือนนี้แล้ว เดือนหน้าใช้ได้อีกรอบ",
  error: "ตอนนี้ระบบรับโค้ดขัดข้องชั่วคราว อีกลองพิมพ์โค้ดมาใหม่",
  bad_input: "โค้ดนี้อาจารย์หาไม่เจอ ลองเช็คตัวสะกดจากเพื่อนอีกที",
};

export function buildReferrerNotifyText() {
  return "เพื่อนของคุณเข้ามารับสิทธิ์จากโค้ดชวนแล้ว อาจารย์เพิ่มสิทธิ์สแกนฟรีให้คุณ 1 ครั้ง ขอบคุณที่ช่วยบอกต่อ";
}
