 ...
 * @property {{ meaningParagraphs: string[], lifeAreaBlurbs: { work: string, relationship: string, money: string }, usageCautionLines: string[], energyTiming?: { bestTimeText?: string, bestDayText?: string, recommendedModeText?: string, focusAmplifierNote?: string } }} [htmlReport] — public HTML-only blocks (not Flex)
