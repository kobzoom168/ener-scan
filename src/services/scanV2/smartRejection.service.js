...
export async function generateSmartRejectionText(p) {
  ...
  try {
    ...
    const prompt = [
      ...
      "ห้ามเกิน 3 บรรทัด ไม่ใส่อีโมจิ ไม่มีเครื่องหมายคำพูด ห้ามใช้เครื่องหมายขีดคั่นประโยค (— – หรือ -) คนจริงไม่พิมพ์แบบนั้น ตอบเฉพาะข้อความที่จะส่งให้ลูกค้าเท่านั้น",
    ].join("\n");
