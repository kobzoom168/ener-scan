...
const MULTI_IMAGE_WAIT_TEXT_STERN =
  "ชิ้นแรกยังอยู่ในคิว รูปที่ส่งเพิ่มยังไม่ถูกหักสิทธิ์\nรอผลชิ้นแรกก่อน แล้วค่อยส่งชิ้นถัดไปทีละรูป";

/** รูปตามมาในหน้าต่างหน่วง: แนบเข้าชุดเดียวกัน อาจารย์ดูจากรูปแรกเป็นหลัก */
const DEBOUNCE_ATTACHED_TEXT =
  "ได้รับเพิ่มอีกรูป อาจารย์ขอดูจากรูปแรกเป็นหลัก 1 ชิ้นต่อ 1 รูป\nถ้าเป็นคนละชิ้น รอผลชิ้นแรกออกก่อน แล้วค่อยส่งชิ้นถัดไป";
