...
const PRE_SCAN_ACK_VARIANTS = [
  ...
  "ได้รูปแล้วครับ ส่งให้อาจารย์แปปนึง",
  "รับแล้วนะครับ เข้าคิวอาจารย์ให้ละ",
  "มาละครับ เดี๋ยวอาจารย์ดูให้ รอแปปนึง",
  "ได้ละครับ ส่งต่อให้อาจารย์เลย",
  "รับแล้วครับ รอแปปนะ อาจารย์กำลังดูให้",
  "เข้าคิวให้ละครับ อีกแปปเดียว",
  "ส่งให้อาจารย์แล้วครับ รอแปปนะ",
  "ได้รูปละครับ เดี๋ยวอาจารย์เพ่งให้",
  "รับเรื่องแล้วครับ อีกอึดใจเดียว",
];
...
const MULTI_IMAGE_WAIT_TEXT_STERN =
  "แจ้งไปแล้วนะครับ ให้ส่งทีละ 1 รูป\nส่งพร้อมกันหลายรูปแบบนี้อาจารย์ไม่รับดูให้ รอผลชิ้นแรกเสร็จก่อน แล้วค่อยส่งทีละรูปครับ";
