...
/** ข้อความรับรูป (Codex P1-3 raw log 19-20 ส.ค.): โทนแข็ง คำเดียวจบ —
 *  ตัด ครับ/เดี๋ยว/นาที/ผลมา/เพ่ง ทั้งหมด (73/95 ack เดิมสัญญาเวลา/อนาคต
 *  แล้วระบบทำไม่ได้จริงทุกครั้ง = จุดที่ quality report ตีตก [AUTO] ซ้ำ ๆ) */
