...
const SCAN_FAILURE_TEXT =
  "อ่านรูปนี้ไม่สำเร็จ ส่งใหม่อีกครั้ง " +
  "ถ่ายมุมที่เห็นชิ้นชัดขึ้น";
...
export const RECOVERY_TEXTS = Object.freeze({
  ...
  birthdate_missing:
    "ยังอ่านไม่ได้ ไม่มีวันเกิดในบัญชี\n\n" +
    "พิมพ์ เปลี่ยนวันเกิด หรือกดเมนู เปิดแอป Ener\n\n" +
    "เสร็จแล้วส่งรูปเดิมมาอีกครั้ง",
});
