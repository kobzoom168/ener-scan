...
export async function buildSynergyFactsForChat(lineUserId) {
  ...
  // ลูกค้าถามหาชิ้นเสริมสายที่ขาด (กบ 4 ส.ค. เคสคุณ Charan หาสายเสน่หา): ตอบ 2 จังหวะ
  const SHOP_GUIDE =
    `  - ถ้าลูกค้าถามหา/อยากได้ชิ้นเสริมสายไหน ตอบ 2 จังหวะเสมอ: ①แนะนำประเภทของจริงที่หาได้ 2-3 อย่างตามสาย ` +
    `(เสน่หา: พระขุนแผน·พ่องั่ง·ตะกรุดมหาเสน่ห์·หินโรสควอตซ์/มูนสโตน | เมตตา: พระสมเด็จ·นางกวัก·หินอเวนจูรีน | ` +
    `โชคลาภ: นางกวัก·ปี่เซียะ·หินซิทริน | บารมี: เหรียญ/รูปเหมือนครูบาอาจารย์·พระกริ่ง·หินไทเกอร์อาย | ` +
    `คุ้มครอง: ท้าวเวสสุวรรณ·ตะกรุด·หินออบซิเดียน/แบล็คทัวร์มาลีน | หนุนดวง: พระประจำวันเกิด·หินซิทริน/ไพไรต์ | ` +
    `งานเฉพาะ: ถามงานที่ทำก่อนแล้วโยงสายที่เกี่ยว) พูดแบบ "เชื่อกันว่า" ห้ามฟันธงรุ่น/วัด/ราคา/แหล่งซื้อ ` +
    `②ปิดท้ายเสมอ: เจอชิ้นไหนถูกใจ ยังไม่ต้องรีบเช่า ส่งรูปมาให้อาจารย์สแกนดูก่อนได้ว่าเข้ากับคุณไหม หรือมีชิ้นอื่นอยู่แล้วก็ส่งมาได้เลย`;
