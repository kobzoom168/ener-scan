...
const CTA_STYLES = [
  ...
  { key: "scan", hint: "ชวนส่งชิ้นมาสแกน: 'อยากรู้พลังชิ้นของคุณ กดชื่อช่องแล้วแตะลิงก์แรกได้'" },
  { key: "join", hint: "ชวนลุ้น: 'ส่งชิ้นของคุณเข้ามา คลิปหน้าอาจเป็นชิ้นของคุณก็ได้'" },
];
