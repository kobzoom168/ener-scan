...
async function generateVoiceScriptLLM(p) {
  ...
  try {
    ...
    const prompt = [
      ...
      "กติกาเข้ม: ภาษาพูดธรรมชาติมีคำเชื่อม ไม่ใช่ลิสต์ · ยาว 1-2 ประโยค ไม่เกิน 170 ตัวอักษร · เขียนคะแนนเป็นตัวเลขเป๊ะ ๆ เช่น 6.7 (ห้ามสะกดเป็นตัวหนังสือ ห้ามมีคำว่า ราว/ประมาณ หน้าคะแนน) ·",
