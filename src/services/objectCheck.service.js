...
- รูปปั้น/รูปหล่อสายมูทุกแบบ = supported: พระพุทธรูป รูปหล่อพระเกจิ องค์เทพ เทวรูป กุมารทอง นางกวัก พญานาค ฤๅษี (กบ 12 ก.ค.: รับรูปปั้นทั้งหมด)
- งานยันต์ทุกแบบ = supported: ผ้ายันต์ ถุงยันต์/ถุงทรัพย์ที่พิมพ์ยันต์ ผ้าประเจียด ธงยันต์ ตะกรุดผ้า (กบ 15 ก.ค.) — ผืนเดียว/ใบเดียวนับเป็น 1 ชิ้น เห็นลายยันต์ อักขระ หรือรูปเกจิบนผ้า = supported อย่าตีเป็นกระเป๋า/ของใช้ทั่วไปแม้เห็นเป็นถุงทั้งใบ
...
- ⭐ วัตถุชิ้นเดียวกันถ่ายสองด้าน (ด้านหน้า + ด้านหลัง วางคู่กันในภาพเดียว — ทรง/ขนาด/กรอบเดียวกัน ด้านหนึ่งเป็นองค์พระ อีกด้านเป็นหลัง/ยันต์/แผ่นมวลสาร) = single_supported เสมอ ไม่ใช่ multiple (คนนิยมถ่ายพระคู่หน้า-หลังแบบนี้)
- multiple = วัตถุมงคล **คนละชิ้น** แยกกันมากกว่า 1 ชิ้น / คอลลาจรวมของหลายชิ้น / screenshot รวมหลายภาพของคนละชิ้น
...
- multiple เฉพาะเมื่อมีวัตถุ **คนละชิ้น** แยกกันหลายชิ้นจริง ๆ — ชิ้นเดียวกันถ่ายหน้า-หลัง/หลายมุมในภาพเดียว = single_supported
- ถ้าไม่มั่นใจระหว่าง single_supported กับ multiple: ถ้าสองภาพในรูปดูเป็นทรง/กรอบเดียวกัน (น่าจะชิ้นเดียวหน้า-หลัง) ให้ตอบ single_supported, ถ้าต่างทรง/ต่างชนิดชัด ให้ตอบ multiple
...
- ภาพโคลสอัพ/ครอปที่เห็นเม็ดหิน/คริสตัล/ลูกปัดสายพลัง (เนื้อหินมีลาย/ประกาย) แม้ไม่เห็นวงกำไลครบหรือเห็นเพียงไม่กี่เม็ด = single_supported (เป็นหิน/คริสตัลที่รองรับ) — อย่าตอบ unsupported/unclear/multiple เพียงเพราะครอปใกล้หรือเห็นไม่ครบวง
...
คำอธิบายฟิลด์:
- label: single_supported = วัตถุมงคล/พลังที่รองรับ 1 ชิ้นเป็นหลัก (พระ เครื่องราง หิน/คริสตัลชิ้นเดียว) — รวมถึงชิ้นเดียวกันถ่ายด้านหน้า+ด้านหลังคู่กันในภาพเดียว (ทรง/กรอบเดียวกัน) ให้ objectCount=1
- multiple = วัตถุคนละชิ้นหลายชิ้นแยกกัน / คอลลาจของหลายชิ้น (ไม่ใช่หน้า-หลังของชิ้นเดียว)
- unclear = มองไม่เห็นวัตถุชัด / เบลอมาก / มืดมาก
- unsupported = มั่นใจว่าไม่ใช่วัตถุมงคล (อาหาร คน สัตว์ เอกสาร สลิป ไพ่ทาโรต์/ไพ่ oracle/playing card/การ์ดเกม screenshot meme ทิวทัศน์ ของใช้ทั่วไป ฯลฯ) — รูปปั้น/รูปหล่อสายมู (พระพุทธรูป องค์เทพ เทวรูป กุมารทอง ฤๅษี) = supported
...
- ภาพโคลสอัพ/ครอปเม็ดหิน/คริสตัล/ลูกปัดสายพลัง (เนื้อหินมีลาย/ประกาย) แม้เห็นไม่ครบวงกำไลหรือเห็นไม่กี่เม็ด = single_supported (familyGuess=crystal) — อย่า reject เพราะครอปใกล้/เห็นไม่ครบวง
