...
export const REGISTRATION_GATE_DEFAULTS = Object.freeze({
  ...
  text: "ก่อนส่งรูป ขอข้อมูลผูกผลอ่านกับเจ้าของ ใช้เวลาไม่ถึงนาที เสร็จแล้วส่งรูปชิ้นแรกได้ฟรีเลย",
});
...
const REG_PROMPT_VARIANTS = [
  ...
  "ลงทะเบียนแปปเดียว กดปุ่มด้านล่างได้ เสร็จแล้วส่งรูปมาได้ทันที",
  "เหลือแค่ลงทะเบียน กดลิงก์แล้วกรอกชื่อ วันเกิด เบอร์ติดต่อ อาจารย์จะได้อ่านให้ตรงดวง",
];
