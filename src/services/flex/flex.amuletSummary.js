...
/** บรรทัดรองในการ์ดเด่นสุด (รอง…) —เบากว่าบรรทัดแรก */
const AMULET_FIT_SECOND_LINE_COLOR = "#57534e";
/**
 * การ์ดสรุป “เด่นสุด” — แยกจากการ์ดเทาทั่วไป: พื้นครีม + ขอบทอง (ดูเด่นใน bubble เทา).
 */
const FLEX_FIT_HIGHLIGHT_BG = "#fffbeb";
const FLEX_FIT_HIGHLIGHT_BORDER = "#ca8a04";
  ...
  if (summaryTwo != null) {
    fitBlockContents = [
      ...
      },
      {
        ...
        size: "xs",
        color: AMULET_FIT_SECOND_LINE_COLOR,
        weight: "regular",
        wrap: true,
        maxLines: 1,
      },
  ...
  const fitBlock =
    fitBlockContents != null
      ? {
          ...
          margin: "md",
          paddingAll: "14px",
          backgroundColor: FLEX_FIT_HIGHLIGHT_BG,
          cornerRadius: "lg",
          borderWidth: "2px",
          borderColor: FLEX_FIT_HIGHLIGHT_BORDER,
