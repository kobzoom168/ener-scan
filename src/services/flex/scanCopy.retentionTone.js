...
const HOOK = {
  youthful: {
    high: [
      "เข้าอยู่ดี ชิ้นอื่นคนละมุมไหม",
      "เทียบอีกชิ้น จะรู้ว่าต่างยังไง",
    ],
    mid: [
      "พกบ่อยชิ้นนี้ ชิ้นอื่นไหม",
      "อีกชิ้นฟีลต่างไหม",
    ],
    low: [
      "บางทีเข้ากว่านี้ก็มี",
      "ยังไม่โดนใจ ชิ้นถัดไปรอ",
    ],
  },
  warm: {
    high: [
      "พกบ่อยชิ้นนี้ เทียบชิ้นอื่นดู",
      "อีกชิ้นพลังต่างไหม",
    ],
    mid: [
      "มีชิ้นอื่นอยากให้ดูบ้าง",
      "ชิ้นต่อไปเข้าต่างไหม",
    ],
    low: [
      "ยังไม่โดนจุดที่อยากได้ ชิ้นอื่นไหม",
      "อยากเทียบเพิ่มก็ได้",
    ],
  },
  mystic: {
    high: [
      "ชิ้นนี้คุ้มใจ ชิ้นถัดไปเด่นคนละทางไหม",
      "พลังเงียบแต่ลึก เทียบอีกชิ้นไหม",
    ],
    mid: [
      "ชิ้นต่อไปจะสัมผัสต่างไหม",
      "พกประจำชิ้นนี้ ชิ้นอื่นไหม",
    ],
    low: [
      "ยังไม่ใช่ชิ้นที่สุด ชิ้นถัดไปรอ",
      "มุมอื่นก็อยากดู",
    ],
  },
};
