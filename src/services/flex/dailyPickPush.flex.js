  ...
  const bodyContents = [
    ...
    ...(teaser
      ? [
          {
            type: "text",
            text: "เปิดสิทธิ์แล้วดูได้ว่าชิ้นไหน จะได้พกถูกชิ้นวันนี้",
            size: "sm",
            color: "#555555",
            wrap: true,
            margin: "md",
    ...
    {
      type: "text",
      text: "มีชิ้นอื่นที่บ้าน ส่งมาสแกนเทียบดูได้ เผื่อมีตัวแรงกว่านี้",
      size: "xs",
      color: "#999999",
      wrap: true,
      margin: "md",
...
export function buildAxisTopPieceFlex(p) {
  ...
  const bodyContents = [
    ...
    },
    {
      type: "text",
      text: teaser
        ? "เปิดสิทธิ์แล้วดูได้ว่าชิ้นไหน พร้อมรายงานเต็มของชิ้นนี้"
        : "กดเปิดดูรายงานเต็มของชิ้นนี้ได้",
      size: "xs",
      color: "#666666",
      wrap: true,
      margin: "md",
