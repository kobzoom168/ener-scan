...
export function renderDeepScanJsonToLegacyText(p, objectCategory, options = {}) {
  ...
  return `ผลการตรวจพลังวัตถุ โดย อาจารย์ Ener
...
• โทนพลัง: หลากมิติ | ดูจากแนนรายด้าน (สังเกตความต่างของแนนแต่ละมิติ)
...
${tip2}
ปิดท้าย
หากอยากคุยต่อหรือสแกนชิ้นอื่น ส่งรูปมาได้`.trim();
}
