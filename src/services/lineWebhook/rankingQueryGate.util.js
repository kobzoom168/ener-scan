...
const RANKING_RE =
  /(แรงสุด|แรงที่สุด|สูงสุด|สูงที่สุด|ดีสุด|ดีที่สุด|เด่นสุด|เด่นที่สุด|อันดับ|จัดอันดับ|ท็อป|top\s*\d*|เทียบคะแนน|คะแนนเยอะสุด|เข้ากับ(?:ผม|ฉัน|เรา|ดวง(?:ผม|ฉัน)?)?\s*(?:มาก)?ที่สุด|เหมาะ(?:กับ(?:ผม|ฉัน|เรา))?\s*(?:มาก)?ที่สุด)/i;
