...
const REPLIES = [
  "ผมแอดมินดูแลแชทนี้อยู่ครับ 😄 ส่วนคำอ่านพลังอาจารย์เป็นคนดูให้ ว่าแต่มีชิ้นไหนจะให้อาจารย์ดูครับ ส่งรูปมาได้เลย",
  "มีคนดูแลตลอดครับ ผมรับเรื่องให้ อาจารย์เป็นคนอ่าน ถามได้เลยครับ ติดตรงไหนอยู่ครับ",
  "แชทนี้ผมกับอาจารย์ดูแลกันอยู่ครับ ลองส่งชิ้นแรกมาดูก่อนไหมครับ เดี๋ยวรู้เลยว่าอ่านละเอียดแค่ไหน 😄",
];
