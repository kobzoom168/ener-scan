...
export function buildFollowWelcomeText() {
  return [
    ...
    "",
    "อาจารย์ช่วยดู “พลัง 6 ด้าน” ของพระ เครื่องราง และวัตถุมงคล จากรูปถ่ายให้ได้เลยครับ",
    "",
    "วิธีใช้ง่ายมาก",
    "1) ถ่ายรูปวัตถุมงคล 1 ชิ้น (ส่งทีละรูปนะครับ)",
    "2) ส่งรูปเข้ามาในแชตนี้ได้เลย",
    "3) รออาจารย์วิเคราะห์สักครู่ แล้วรับการ์ดพลังกลับไป",
    "",
    "วันนี้สแกนฟรีได้ 2 ครั้ง ส่งรูปแรกมาได้เลยครับ 📿",
    "",
    "* ผลวิเคราะห์เป็นไปตามความเชื่อเพื่อการพิจารณาส่วนบุคคล ไม่ได้รับรองว่าพระแท้หรือประเมินราคา",
  ].join("\n");
}

export function buildMultipleObjectsText() {
  return [
    "ในรูปมีหลายองค์อยู่นะครับ 🙏",
    "อาจารย์ขอดูทีละองค์จะอ่านพลังได้แม่นสุด",
    "รบกวนถ่ายทีละชิ้นแล้วส่งกลับมาใหม่ได้เลยครับ",
  ].join("\n");
}
