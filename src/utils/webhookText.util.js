...
// Codex P1-3 (raw log 19-20 ส.ค.): โทนแข็ง สั้น — ไม่มี ครับ/emoji/คำปลอบ
export function buildUnsupportedObjectText() {
  return "ชิ้นนี้ยังอ่านไม่ได้ ส่งภาพชิ้นเดียวให้เต็มกรอบ";
}
...
export function getUnsupportedObjectReplyCandidates() {
  return [
    ...
    "ยังอ่านชิ้นนี้ไม่ได้ ถ่ายใหม่ให้เห็นชิ้นเดียวเต็มกรอบแล้วส่งมาอีกครั้ง",
  ];
}
