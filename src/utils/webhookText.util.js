...
export function buildPaymentRequiredText({ usedScans = 0, freeLimit = 3 } = {}) {
  ...
  return [
    ...
    "ราคา 99 บาท",
    `QR เพื่อโอน: ${qrUrl}`,
    "โอนแล้วส่งสลิปในแชทนี้เพื่อให้แอดมินตรวจสอบ",
    "เมื่อแอดมินอนุมัติแล้ว ระบบจะเปิดสิทธิ์ให้ทันที",
    "",
...
export function buildPaymentInstructionText({
  ...
  return [
    ...
    "หลังโอนเงินแล้ว กรุณาส่งสลิปในแชทนี้เพื่อให้แอดมินตรวจสอบการชำระเงิน",
  ].join("\n");
}
...
export function buildSlipReceivedText() {
  return [
    "✅ รับสลิปแล้วครับ",
    "",
    "ระบบกำลังตรวจสอบการชำระเงินโดยแอดมิน",
    "เมื่ออนุมัติแล้ว คุณจะสแกนต่อได้ทันที",
  ].join("\n");
}
