 ...
 *
 * Primary LINE path: DB-backed copy via `resolveEnergyCopyForFlex` + `energy_copy_templates`.
 * Pools below remain fallback when DB rows are missing or Supabase errors.
 */
