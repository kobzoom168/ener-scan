...
export const REPLY_VARIANTS = {
  birthdate_update_prompt: [
    "ขอวันเกิดชุดใหม่หน่อย",
    "บอกวันเกิดใหม่ในแชตนี้ได้",
    "จะใช้วันเกิดแทนเดิมเป็นอันไหน บอกอาจารย์ได้",
  ],

  birthdate_saved_after_update: [
    "โอเค อาจารย์ตั้งวันเกิดนี้ให้แล้ว\n\nส่งรูปมาได้",
    "บันทึกวันเกิดใหม่แล้วนะ ส่งรูปมาได้",
    "เซฟวันเกิดใหม่เรียบร้อย ส่งรูปต่อได้",
  ],
};
