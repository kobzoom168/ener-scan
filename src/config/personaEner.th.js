...
export const PERSONA_REPLY_CONFIG = {
  ...
  paywall: {
    ...
    pools: {
      CONTEXT: [
        "ผมดูคร่าว ๆ ให้แล้วนะ",
        "รอบฟรีวันนี้หมดแล้วนะ",
        "ฟรีวันนี้ครบแล้วครับ",
        "โควตาฟรีวันนี้เต็มแล้ว",
      ],
      OFFER: [
        "ถ้าจะดูละเอียดกว่านี้ ผมมีผลเต็มให้",
        "อยากได้คำอ่านแบบเต็ม ๆ จัดให้ได้",
        "อยากดูละเอียดกว่านี้ มีแพ็กผลเต็ม",
        "จะขยายคำอ่านแบบเต็ม มีให้ครับ",
      ],
      CTA: [
        "ราคา {{AMOUNT}} บาท\n\nถ้าพร้อม พิมพ์ จ่ายเงิน ได้เลย",
        "ราคา {{AMOUNT}} บาท\n\nพิมพ์ จ่ายเงิน แล้วผมส่งวิธีให้",
        "ราคา {{AMOUNT}} บาท\n\nพร้อมเมื่อไหร่ พิมพ์ จ่ายเงิน ได้เลย",
        "ราคา {{AMOUNT}} บาท\n\nพิมพ์ จ่ายเงิน ได้เลย",
      ],
    },
  },
