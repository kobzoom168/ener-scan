...
7. **Gemini object-form 429 incident (แยก — Codex ข้อ 5)**: GEMINI_OBJECT_FORM_FAILED 22 ครั้ง/24 ชม. บน pro จาก Google direct quota — เลือกทาง: เพิ่ม quota / ย้าย second-opinion ไป OpenRouter / ปิด flag ชั่วคราว (GEMINI_OBJECT_FORM_ENABLED) · scan ไม่ล้ม (fail-open) แต่เกตธูป/ของใช้พิธีแม่นลดลง
