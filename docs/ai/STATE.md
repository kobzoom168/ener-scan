...
- **โพสต์เพจอัตโนมัติทุกสแกน (LIVE pro 29 ก.ค.)**: ทุกสแกนที่ทำการ์ดได้ → ① คลิปซูม 5 วิ (ffmpeg zoompan เฟรมแนวนอน 1920x1080 การ์ดกลาง+พื้นเบลอ + เพลงกบ) → FB จัดเป็น Reel เสมอ (นโยบาย FB — เอา reach) ② รูปการ์ด photo post ขึ้นไทม์ไลน์เพจ (เอาหน้าเพจ) — แคปชันเดียวกัน: บรรทัดนำ "ชิ้นนี้จากคุณ {ชื่อ}" (DB ไม่มีชื่อ → ดึง LINE profile + backfill) + แคปชันพลังงาน (🚫ห้ามบอกประเภทวัตถุ พระ/หิน/กำไล — "ชิ้นนี้" เท่านั้น ทั้ง prompt+แฮชแท็ก #วัตถุมงคล #สายมู+regex ตาข่าย) · scanClipVideo.service hook ใน deliverOutbound · env SCAN_CLIP_FB_ENABLED (default true, staging=false) · แทนวิดีโอสรุปรายวัน 17:00 (ยกเลิก+ลบแล้ว)
