...
- **คลิปซูม 5 วิต่อสแกน (LIVE pro 29 ก.ค.)**: ทุกสแกนที่ทำการ์ดได้ → ffmpeg zoompan 5 วิ + เพลงกบ → auto post เพจ FB พร้อมแคปชัน social เดิม · scanClipVideo.service hook ใน deliverOutbound · env SCAN_CLIP_FB_ENABLED (default true, staging=false) · แทนวิดีโอสรุปรายวัน 17:00 (ยกเลิก+ลบแล้ว) 
