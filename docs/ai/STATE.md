...
- **วิดีโอสรุปรายวัน (รอ pro)**: การ์ดของวันต่อกันเป็น mp4 + เพลงกบ (daily_recap.m4a) → เพจ FB 17:00 + สำเนา Telegram · dailyRecapVideo.service + postPageVideo + sendTelegramVideo · env DAILY_RECAP_VIDEO_ENABLED/HOUR · staging ปิดไว้ (false) กันโพสต์ซ้อน — pro ยังไม่ deploy รอกบเคาะ
